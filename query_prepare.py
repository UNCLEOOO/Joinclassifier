...
7. condition中的字段名必须和节点中的alias完全一致
...
def process_dbt_project(project_name: str):
    ...
    try:
        # 构造路径
        project_dir = Path(f"D:/MasterLife/Researches/2025.8.10-AutoETL/dbt_google_ads-main/integration_tests")
        output_dir = Path(f"D:/MasterLife/Researches/2025.8.10-AutoETL/dbt_dataset_1/{project_name}")
...
# python D:/MasterLife/Researches/2025.8.10-AutoETL/new_pipeline/query_prepare.py app_reporting -v
